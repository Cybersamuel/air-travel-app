      ...
      <div className="login-box">
        ...
        <form>
          <div className='user-box'>
            ...
            automotive industry and private security. We are also a leading travel agency in this world <br/>
            <br/>
            <ul>
              ...
              <li>Redstone Technologies - Our wing that specializes in IT and Research & Development.</li><br/>
              <li>Redstone Travel - The travel agency that gives you cheap travel deals</li>
            </ul>
          </div>     
        </form>
      </div>
